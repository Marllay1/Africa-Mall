...
**Web Seller Center (§7-17)** : ✅ livré en v8 (§3 phase 9) — Finances réelles, Premium Seller, Paramètres Seller dédiés, statuts de commande étendus. Reste néanmoins hors périmètre de v8 : Premium Customer côté visibilité avancée (campagnes promotionnelles, produits sponsorisés au sens pub — v8 ne couvre que le tri/badge boutique), notifications réelles de retrait/validation Premium (pas d'email/notif envoyée aujourd'hui, juste visible en rechargeant la page), export/pagination réelle de l'historique transactions (actuellement les 30 dernières entrées, pas de pagination). (Sidebar complète, topbar et dashboard à vraies données livrés en v5 — voir §3 phase 7.)
